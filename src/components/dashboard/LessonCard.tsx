...
// Completed lessons show a checkmark icon, locked lessons are grayed out,
// and available lessons are styled normally.
// It is used in the HomePage to display a list of lessons.
...
export default function LessonCard({
  ...
  const baseClasses =
    "relative rounded-2xl px-4 py-6 shadow-md w-40 h-32 flex-shrink-0 flex flex-col justify-center items-center text-center";
